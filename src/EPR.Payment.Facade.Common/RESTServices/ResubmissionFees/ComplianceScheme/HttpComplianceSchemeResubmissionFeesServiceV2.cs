...
{
    public class HttpComplianceSchemeResubmissionFeesServiceV2 : BaseHttpService, IHttpComplianceSchemeResubmissionFeesServiceV2
    {
        public HttpComplianceSchemeResubmissionFeesServiceV2(
