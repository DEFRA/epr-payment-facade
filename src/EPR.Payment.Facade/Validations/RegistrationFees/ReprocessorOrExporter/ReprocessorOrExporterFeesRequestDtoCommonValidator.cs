...
{
    public abstract class ReprocessorOrExporterFeesRequestDtoCommonValidator<T> : AbstractValidator<T> where T : ReprocessorOrExporterRegistrationFeesRequestDto
    {
        protected ReprocessorOrExporterFeesRequestDtoCommonValidator()
        {
