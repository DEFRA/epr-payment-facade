...
{
    [TestClass]
    public class HttpProducerFeesServiceV2Tests
    {
        private Mock<IHttpContextAccessor> _httpContextAccessorMock = null!;
        private Mock<IOptionsMonitor<Service>> _configMonitorMock = null!;
        private ProducerFeesRequestV2Dto _producerFeesRequestDto = null!;
        ...
        private HttpProducerFeesV2Service CreateHttpProducerFeesService(HttpClient httpClient)
        {
            return new HttpProducerFeesV2Service(
                httpClient,
        ...
        {
            // Act
            Action act = () => _ = new HttpProducerFeesV2Service(
                new HttpClient(),
                null!,
                _configMonitorMock.Object);
        ...
        public void Constructor_ConfigMonitorIsNull_ShouldThrowNullReferenceException()
        {
            ...
            // Act & Assert
            Action act = () => _ = new HttpProducerFeesV2Service(httpClient, httpContextAccessor, null!);
        ...
        public async Task CalculateProducerFeesAsync_ValidRequest_ReturnsRegistrationFeesResponseDto(
            ...
            HttpProducerFeesV2Service httpProducerFeesService,
        ...
        public async Task CalculateProducerFeesAsync_HttpRequestException_ThrowsServiceException(
            [Frozen] Mock<HttpMessageHandler> handlerMock,
            Mock<IOptions<Service>> configMock,
            HttpProducerFeesV2Service httpRegistrationFeesService,
            CancellationToken cancellationToken)
        {
            // Arrange
            handlerMock.Protected()
