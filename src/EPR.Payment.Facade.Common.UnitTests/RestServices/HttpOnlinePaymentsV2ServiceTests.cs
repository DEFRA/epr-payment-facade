...
namespace EPR.Payment.Facade.Common.UnitTests.RESTServices
{
    ...
    public class HttpOnlinePaymentsV2ServiceTests
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            // Act
            var result = await httpOnlinePaymentsService.GetOnlinePaymentDetailsV2Async(externalPaymentId, cancellationToken);
            ...
            CancellationToken cancellationToken)
        {
            ...
            // Act
            Func<Task> act = async () => await httpOnlinePaymentsService.GetOnlinePaymentDetailsV2Async(externalPaymentId, cancellationToken);
