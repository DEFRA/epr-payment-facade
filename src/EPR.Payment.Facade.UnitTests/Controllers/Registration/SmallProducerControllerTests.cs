...
{
    [TestClass]
    public class SmallProducerControllerTests
    {
        private Mock<IFeeCalculatorFactory> _feeCalculatorFactoryMock;
        private Mock<ILogger<SmallProducerController>> _loggerMock;

        [TestInitialize]
        public void Setup()
        {
            _feeCalculatorFactoryMock = new Mock<IFeeCalculatorFactory>();
            _loggerMock = new Mock<ILogger<SmallProducerController>>();
        }
        ...
        {
            // Arrange
            var controller = new SmallProducerController(_feeCalculatorFactoryMock.Object, _loggerMock.Object);
