...
{
    [TestClass]
    public class LargeProducerControllerTests
    {
        private Mock<IFeeCalculatorFactory> _feeCalculatorFactoryMock;
        private Mock<ILogger<LargeProducerController>> _loggerMock;

        [TestInitialize]
        public void Setup()
        {
            _feeCalculatorFactoryMock = new Mock<IFeeCalculatorFactory>();
            _loggerMock = new Mock<ILogger<LargeProducerController>>();
        }
        ...
        {
            // Arrange
            var controller = new LargeProducerController(_feeCalculatorFactoryMock.Object, _loggerMock.Object);
