...
{
    [TestClass]
    public class ComplianceSchemeResubmissionFeeRequestV2DtoValidatorTests
    {
        private ComplianceSchemeResubmissionFeeRequestV2DtoValidator _validator = null!;

        [TestInitialize]
        public void Setup()
        {
            _validator = new ComplianceSchemeResubmissionFeeRequestV2DtoValidator();
        }
        ...
        {
            // Arrange
            var request = new ComplianceSchemeResubmissionFeeRequestV2Dto
            {
